...
namespace Tutor_Managment_System_Project
{
    public partial class Tutor_Signup : System.Web.UI.Page
    {
        ...
        void Tutor_Reset_Form()
        {
            ...
            AddressTextBox.Text = "";
            QualificationDropDownList.SelectedValue = null;
            DegreeTextBox.Text = "";
            ExperienceDropDownList.SelectedValue = null;
            ContactTextBox.Text = "";
        ...
        protected void TutorSignUpButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add("@martial_status", SqlDbType.VarChar).Value = MaritalStatusDropDownList.SelectedItem.ToString();
                cmd.Parameters.Add("@state", SqlDbType.VarChar).Value = StateDropDownList.SelectedItem.ToString();
                cmd.Parameters.Add("@district", SqlDbType.VarChar).Value = CityDropDownList.SelectedItem.ToString();
                cmd.Parameters.Add("@address", SqlDbType.VarChar).Value = AddressTextBox.Text;
                cmd.Parameters.Add("@qualification", SqlDbType.VarChar).Value = QualificationDropDownList.SelectedItem.ToString();
                cmd.Parameters.Add("@degree", SqlDbType.VarChar).Value = DegreeTextBox.Text;
                cmd.Parameters.Add("@experience", SqlDbType.VarChar).Value = ExperienceDropDownList.SelectedItem.ToString();
