<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin_dashboard.Master" AutoEventWireup="true" CodeBehind="View_Contact.aspx.cs" Inherits="Tutor_Managment_System_Project.admin.View_Contact" %>
...
<br />   
    <div class="row">
     ...
     <asp:GridView CssClass="table table-bordered table-hover table-striped table-dark" ID="ContactGridView" runat="server" AutoGenerateColumns="False" OnRowDeleting="ContactGridView_RowDeleting">
         <Columns>
