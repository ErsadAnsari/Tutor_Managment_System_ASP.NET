<%@ Page Title="" Language="C#" MasterPageFile="~/TMS_Site.Master" AutoEventWireup="true" CodeBehind="Student_Signup.aspx.cs" Inherits="Tutor_Managment_System_Project.Student_Signup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container" style="box-shadow: 1px 2px 25px 0px rgba(0,0,0,0.75); -webkit-box-shadow: 1px 2px 25px 0px rgba(0,0,0,0.75); -moz-box-shadow: 1px 2px 25px 0px rgba(0,0,0,0.75);">
        <br />
        <div class="row">
            <div class="col-md-12">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <asp:DropDownList ID="StateDropDownList" OnSelectedIndexChanged="StateDropDownList_SelectedIndexChanged" AutoPostBack ="true" CssClass="form-control" runat="server">
                </asp:DropDownList>
                <asp:RequiredFieldValidator InitialValue="Select State" ControlToValidate="StateDropDownList" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ID="RequiredFieldValidator18" runat="server" ErrorMessage="Select State"></asp:RequiredFieldValidator>
            </div>
            ...
            <div class="col-md-4">
                ...
                <asp:RequiredFieldValidator InitialValue="Select District" ControlToValidate="CityDropDownList" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ID="RequiredFieldValidator6" runat="server" ErrorMessage="Select District"></asp:RequiredFieldValidator>
            ...
            <div class="col-md-4">
                ...
                <br />
                <asp:TextBox ID="UsernameTextBox" CssClass="form-control" OnTextChanged="UsernameTextBox_TextChanged" AutoPostBack="true" placeholder="Enter Username" runat="server"></asp:TextBox>
