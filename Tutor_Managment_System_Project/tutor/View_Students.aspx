<%@ Page Title="" Language="C#" MasterPageFile="~/tutor/Tutor_Dashboard.Master" AutoEventWireup="true" CodeBehind="View_Students.aspx.cs" Inherits="Tutor_Managment_System_Project.tutor.View_Students" %>
            ...
            <ItemTemplate>
                ...
                <div class="col-md-4">
                    ...
                    <div class="card-body">
                        ...
                        <h5><asp:Label ID="Label3" runat="server" Text='<%# Bind("state") %>'></asp:Label></h5>   
                        ...
                        <h5><asp:Label ID="Label9" runat="server" Text='<%# Bind("tutiontype") %>'></asp:Label></h5>
                    </div>
