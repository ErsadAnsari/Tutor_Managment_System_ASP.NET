<%@ Page Title="" Language="C#" MasterPageFile="~/student/Student_Dashboard.Master" AutoEventWireup="true" CodeBehind="View_Tutors.aspx.cs" Inherits="Tutor_Managment_System_Project.student.View_Tutors" %>
                ...
                <div class="col-md-4">
                    ...
                    <div class="card bg-dark text-white text-center">
                        ...
                        <div class="card-body">
                            ...
                            <h5>
                                <asp:Label ID="Label3" runat="server" Text='<%# Bind("state") %>'></asp:Label></h5>
                            <small style="font-size: 15px; color: steelblue;">District</small>
                            <h5>
                                <asp:Label ID="Label4" runat="server" Text='<%# Bind("district") %>'></asp:Label></h5>
