<%@ Page Title="" Language="C#" MasterPageFile="~/TMS_Site.Master" AutoEventWireup="true" CodeBehind="Tutor_Signup.aspx.cs" Inherits="Tutor_Managment_System_Project.Tutor_Signup" %>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
               ...
               <asp:DropDownList ID="StateDropDownList" OnSelectedIndexChanged="StateDropDownList_SelectedIndexChanged"  AutoPostBack ="true" CssClass="form-control" runat="server">
                ...
                <asp:RequiredFieldValidator InitialValue="Select State" ControlToValidate="StateDropDownList" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ID="RequiredFieldValidator6" runat="server" ErrorMessage="Select State"></asp:RequiredFieldValidator>
                <br />
                <asp:DropDownList ID="CityDropDownList"   CssClass="form-control"  runat="server">
                    <%--<asp:ListItem>Select City</asp:ListItem>--%>
                </asp:DropDownList>
                <asp:RequiredFieldValidator InitialValue="Select District" ControlToValidate="CityDropDownList" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ID="RequiredFieldValidator7" runat="server" ErrorMessage="Select District"></asp:RequiredFieldValidator>
                <br />
